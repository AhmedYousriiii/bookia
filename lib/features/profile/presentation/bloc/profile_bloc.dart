...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  Future<void> getprofile(GetProfileEvent event, Emitter<ProfileState> emit) async {
    ...
    try {
      ...
      emit(ProfileErrorState(message: 'Unexpected Error occur, please tryy again'));
    }
  }

  Future<void> logoutprofile(LogoutEvent event, Emitter<ProfileState> emit) async {
  ...
  Future<void> updateProfile(updateprofileEvent event, Emitter<ProfileState> emit) async {
